...
\begin{equation}
 \left\{ \lnot A , \lnot Sh , L \right\} \tag{4.1} \label{4.1}
\end{equation}
\begin{equation}
\left\{ A , Sh \right\} \tag{4.2} \label{4.2}
\end{equation}
\begin{equation}
\left\{ A , \lnot L \right\} \tag{4.3} \label{4.3}
\end{equation}

\begin{equation}
 \left\{ \lnot G , \lnot W , P \right\} \tag{5.1} \label{5.1}
\end{equation}
\begin{equation}
\left\{ G , W \right\} \tag{5.2} \label{5.2}
\end{equation}
\begin{equation}
\left\{ G , \lnot P \right\} \tag{5.3} \label{5.3}
\end{equation}

\begin{equation}
 \left\{ \lnot I , E , St \right\} \tag{6.1} \label{6.1}
\end{equation}
\begin{equation}
\left\{ I , \lnot E \right\} \tag{6.2} \label{6.2}
\end{equation}
\begin{equation}
\left\{ I , \lnot St \right\} \tag{6.3} \label{6.3}
\end{equation}
...
\end{equation}
\begin{equation}
\left\{ M , P \right\} \tag{8.2} \label{8.2}
\end{equation}
\begin{equation}
\left\{ M , \lnot C \right\} \tag{8.3} \label{8.3}
\end{equation}
